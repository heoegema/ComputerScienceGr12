//Simple Bubble Sort
//This program will collect up to 20 values and store them in a vector
//Display the vector, sort the vector and then display it again
//Exercise 1 pg. 49
//Date April 25 2015
...
//Prototypes
void BubbleSort(int i, apvector<int> &Integers); 
...

{
    ...
    cout << "\t\t\tInteger Sort with Simple Bubble Sort";
    cout << "\n\nYou can enter up to 20 integers between 0-100.";
    cout << "\nOnce you're finished enter any negative number to exit.\n";
  	cout << "\nThis program will then sort your numbers into ascending order using Simple Bubble Sort.\n\n"; 
    //Collecting Values
   ...
   if (i == 0)  //There is a possibility that no values were assigned to the vector
    ...
    { 
        ...
        BubbleSort(i, Integers); //Call on the function that will sort the vector
...
void BubbleSort(int i, apvector<int> &Integers) //We put an & next to the Integer vector because we want to modify the vector itself
{ 
